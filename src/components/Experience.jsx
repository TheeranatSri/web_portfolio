            ...
            <div className="experience-container">
                ...
                <aside className="experience-sidebar">
                    ...
                    <div className="sidebar-card">
                        <h4 className="sidebar-title">Core Technologies</h4>
                        <div className="sidebar-tags">
                            <span className="sidebar-tag">Python</span>
                            <span className="sidebar-tag">SQL</span>
                            <span className="sidebar-tag">FastAPI</span>
                            <span className="sidebar-tag">Docker</span>
                            <span className="sidebar-tag">Power BI</span>
                            <span className="sidebar-tag">Loocker Studio</span>
                            <span className="sidebar-tag">Git</span>
                            <span className="sidebar-tag">LLMs</span>
                        </div>
                    </div>

                    <div className="sidebar-card">
                        <h4 className="sidebar-title">Domains</h4>
                        <div className="sidebar-tags">
                            <span className="sidebar-tag">Retail</span>
                            <span className="sidebar-tag">E-commerce</span>
                            <span className="sidebar-tag">Insurance</span>
                            <span className="sidebar-tag">Analytics</span>
                        </div>
                    </div>
                </aside>
            </div>
